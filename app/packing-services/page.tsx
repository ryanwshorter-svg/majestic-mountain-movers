...
export const metadata: Metadata = {
  title: "Professional Packing Services Summit County CO | Majestic Mountain Movers",
  description: "Professional packing services in Summit County, CO. Full-service packing for local and interstate moves. Fragile items, pianos, art — handled with care. Call 970-468-8815.",
  alternates: { canonical: "https://www.majesticmountainmovers.com/packing-services" },
};
      ...
      <section className="relative py-24" style={{background:"linear-gradient(135deg, #4A2970 0%, #6B3FA0 100%)"}}>
        <div className="max-w-7xl mx-auto px-4 text-center text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-6" style={{fontFamily:"'Playfair Display',serif"}}>
            Professional Packing Services — Summit County, Colorado
          </h1>
          <p className="text-xl text-purple-100 max-w-2xl mx-auto mb-8">Full-service packing using professional materials — from everyday items to pianos, art, and fragile heirlooms.</p>
