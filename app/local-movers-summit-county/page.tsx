...
export const metadata: Metadata = {
  title: "Local Movers Summit County CO | Breckenridge, Vail & Colorado Mountains",
  description: "Expert local movers in Summit County, CO. Transparent hourly pricing, mountain-trained crews, no hidden fees. Serving Breckenridge, Vail, Silverthorne & more. Call 970-468-8815.",
  alternates: { canonical: "https://www.majesticmountainmovers.com/local-movers-summit-county" },
};
      ...
      <section className="relative py-24" style={{background:"linear-gradient(135deg, #4A2970 0%, #6B3FA0 100%)"}}>
        <div className="max-w-7xl mx-auto px-4 text-center text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-6" style={{fontFamily:"'Playfair Display',serif"}}>
            Local Movers — Summit County, Colorado
          </h1>
          <p className="text-xl text-purple-100 max-w-2xl mx-auto mb-8">Local moving experts who know every road, HOA, and mountain challenge in Summit County.</p>
